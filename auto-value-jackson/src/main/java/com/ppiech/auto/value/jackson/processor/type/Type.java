...
import com.ppiech.auto.value.jackson.processor.type.collection.ArrayCollectionType;
import com.ppiech.auto.value.jackson.processor.type.collection.CollectionType;
import com.ppiech.auto.value.jackson.processor.type.field.FieldType;
import com.ppiech.auto.value.jackson.processor.type.field.ParameterizedTypeField;
...
public abstract class Type {
  ...
  public abstract void serialize(MethodSpec.Builder builder, int depth, String fieldName,
      List<String> processedFieldNames, String getter, boolean isObjectProperty,
      boolean checkIfNull, String writeIfNull, String writeCollectionElementIfNull);
  ...
  public static class ClassNameObjectMapper {
    ...
    public ClassNameObjectMapper(TypeName className, String objectMapper) {
