...
public class LoganSquare {
    ...
    private static final SimpleArrayMap<Class, com.ppiech.auto.value.jackson.typeconverters.TypeConverter> TYPE_CONVERTERS = new SimpleArrayMap<>();
    static {
    ...
    public static <E> JsonMapper<E> mapperFor(ParameterizedType<E> type, SimpleArrayMap<ParameterizedType, JsonMapper> partialMappers) throws
     ...
     */
    @SuppressWarnings("unchecked")
    public static <E> com.ppiech.auto.value.jackson.typeconverters.TypeConverter<E> typeConverterFor(Class<E> cls) throws
        com.ppiech.auto.value.jackson.NoSuchTypeConverterException {
        com.ppiech.auto.value.jackson.typeconverters.TypeConverter<E> typeConverter = TYPE_CONVERTERS.get(cls);
     ...
     */
    public static <E> void registerTypeConverter(Class<E> cls, com.ppiech.auto.value.jackson.typeconverters.TypeConverter<E> converter) {
